<?php namespace Maatwebsite\Clerk\Tests\Readers;

use Maatwebsite\Clerk\Adapters\PHPExcel\Readers\Reader;
...
class PHPExcelReaderTest extends \PHPUnit_Framework_TestCase {
    ...
    public function test_can_init()
    {
        ...
        $this->assertInstanceOf('Maatwebsite\Clerk\Reader', $reader);
    }
    ...
    public function test_can_get_and_set_settings()
    {
        ...
        $this->assertInstanceOf('Maatwebsite\Clerk\Adapters\ParserSettings', $reader->settings());
    ...
    {
        $reader = $this->getReader();
        $this->assertInstanceOf('Maatwebsite\Clerk\Collections\SheetCollection', $reader->get());
    }
    ...
    {
        $reader = $this->getReader();
        $this->assertInstanceOf('Maatwebsite\Clerk\Collections\SheetCollection', $reader->all());
    }
    ...
    {
        $reader = $this->getReader();
        $this->assertInstanceOf('Maatwebsite\Clerk\Collections\RowCollection', $reader->first());
    }
